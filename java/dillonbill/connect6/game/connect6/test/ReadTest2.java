...
public class ReadTest2{
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for(int i = 100; i <= 2700; i += 100) { */
			player1Gen = 20;
			player1Wins = 0;
			ReadTest1("\\Users\\dillo\\Code\\Connect6Bot\\data\\TestTwo\\data", _network1, board, gs1, player0Gen);
			ReadTest1("\\Users\\dillo\\Code\\Connect6Bot\\data\\TestTwo\\data", _network2, board, gs2, player1Gen);
		
			// for(int j = 0; j < games; j++) {
				_network1.setWeights(gs1.getWeights(3));
				_network2.setWeights(gs2.getWeights(2));
				switch(BotvBotGame.playGameWithBoardPrints(board, _network1, _network2)) {
					case TIE:
						draws++;
						break;
					case BLACK:
