...
public class BotvBotGame {
	...
	static public Player playGame (Board board, Network net1, Network net2) {
	...
	static public Player playGameWithBoardPrints (Board board, Network net1, Network net2) {
	     int height = board.getHeight(); 
	     int width = board.getWidth();
	     int moves = (height * width)/2;
	...
	static public Player playGame (Board board, Network net1) {
